 ...
 */
final class Version20221204130713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact_page CHANGE phone phone INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact_page CHANGE phone phone VARCHAR(255) NOT NULL');
    }
}
